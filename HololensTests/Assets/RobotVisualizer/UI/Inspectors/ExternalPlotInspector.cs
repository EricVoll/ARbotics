...
{
    [CustomEditor(typeof(ExternalPlot))]
    public class ExternalPlotInspector : UnityEditor.Editor
    {
        ...
        protected ExternalPlot externalPlot;
        ...
        private SerializedProperty contentCanvas;
        ...
        public override void OnInspectorGUI()
        {
            ...
            contentCanvas = serializedObject.FindProperty("contentCanvas");
            ...
            bool hasContentCanvas = contentCanvas.objectReferenceValue != null;
            bool hasToolTipLine = toolTipLine.objectReferenceValue != null;
            bool hasAllObjects = (hasAnchor & hasPivot & hasContentParent & hasLabel & hasToolTipLine & hasContentCanvas);
            ...
            if (objectSettingsFoldout || !hasAllObjects)
            {
                ...
                EditorGUILayout.PropertyField(contentCanvas);
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            if (DrawHandles)
            {
                ExternalPlot toolTip = (ExternalPlot)target;
                float handleSize = 0;
                float arrowSize = 0;
