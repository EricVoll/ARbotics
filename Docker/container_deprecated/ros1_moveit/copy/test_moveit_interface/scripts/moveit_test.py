...
class MoveGroupPythonIntefaceTutorial(object):
	...
	def __init__(self):
		...
		# print(scene)
		# print('Init robot')
		#manipulator and endeffector groups 
...
def move_manipulator(data, robot):
	#print("Move the robot to: "+ data.data)
	rospy.loginfo(rospy.get_caller_id() + "move to (%f,%f,%f)"%(data.position.x,data.position.y, data.position.z ))
	robot.go_to_pose_goal(data)



def rossharp_listener():
