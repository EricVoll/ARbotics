...
public class GLDebug : MonoBehaviour
{
	...
	public static bool triggerOfDisp = false;
#if UNITY_EDITOR
...
//");
	...
	void Update()
	{
		...
		if (triggerOfDisp == true)
		{
			displayLines = false;
		}
		else if (triggerOfDisp == false)
		{
			displayLines = true;
		}
	...
	private static void DrawLine(Vector3 start, Vector3 end, Color color, float duration = 0, bool depthTest = true)
	{
