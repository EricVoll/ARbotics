...
namespace RobotVisualizer
{
    ...
    public class ExternalPlot : MonoBehaviour
    {
        ...
        private List<IPlotBackground> backgrounds = new List<IPlotBackground>();
        ...
        protected virtual void OnEnable()
        {
            ...
            backgrounds.Clear();
            foreach (IPlotBackground background in GetComponents(typeof(IPlotBackground)))
            {
        ...
        protected virtual void RefreshLocalContent()
        {
            ...
            if (currentTextLength != prevTextLength || currentTextHash != prevTextHash || currentFontSize != prevFontSize)
            {
                ...
                Vector3 titleBarBackgroundSize = new Vector3(
                    localContentSize.x,
                    this.titleBarBackground.transform.localScale.y,
                    this.titleBarBackground.transform.localScale.z
                ); 

                this.titleBarBackground.transform.localScale = titleBarBackgroundSize;
                ...
                foreach (IPlotBackground background in backgrounds)
                {
